...
{
    // default connection
    public static $dbname = 'eprocurement'; // Your database name
    ...
    public static $autoclean_activate = false;// deactivate multi instance checks. if false means you can now use multiinstance or open multiple instances in different tabs without an issue
