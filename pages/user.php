...
<?php
	...
	$user->confirm_edit_action(true);
	$user->confirm_edit_action_msg("Want to proceed with editing?");
	$user->confirm_add_action(true);
	$user->confirm_add_action_msg("Want to proceed with adding?");
