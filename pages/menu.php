...
?>		
	...
	?>
	<ul style="margin-left: 17px;" id="dashboard<?php echo $counter; ?>" class="nav sidebar-subnav level3-menu <?php echo $level1 != $val ? 'collapse' : 'collapse in' ?>" aria-expanded="<?php echo $level1 != $val ? 'false' : 'true' ?>" style="">
